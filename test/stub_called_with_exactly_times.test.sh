...
assert_raises 'stub_called_with_exactly_times "uname X" 1' 0
assert_raises 'stub_called_with_exactly_times "uname X" 2 Y' 0
assert_raises 'stub_called_with_exactly_times "uname X" 1 Y Z' 0
...
assert_raises 'stub_called_with_exactly_times "uname X" 0' 1
assert_raises 'stub_called_with_exactly_times "uname X" 1 Y' 1
assert_raises 'stub_called_with_exactly_times "uname X" 2 Y Z' 1
