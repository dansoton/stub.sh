...
assert_raises 'stub_called_at_least_times "uname X" 0' 0
assert_raises 'stub_called_at_least_times "uname X" 1' 0
...
assert_raises 'stub_called_at_least_times "uname X" 2' 1
